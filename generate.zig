...
pub fn addConfigFiles(b: *std.Build, wf: *std.Build.Step.WriteFile) void {
    ...
    const version = extractVersionFromUrl(build_zon.dependencies.upstream.url) orelse "0.0.0";
    ...
    const git_rev = extractGitRef(build_zon.dependencies.upstream.url) orelse "zig-build";
